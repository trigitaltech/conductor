...
import { Tabs, Tab, NavLink, SecondaryButton, LinearProgress, Heading } from "../../components";
...
export default function Execution() {
  ...
  const dag = useMemo(()=> execution ? new WorkflowDAG(execution): null, [execution]);
