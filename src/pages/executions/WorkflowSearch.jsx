...
import { Paper, Heading, PrimaryButton, Dropdown, Input } from "../../components";
...
export default function WorkflowPanel() {
  ...
  const {data:resultObj, error, isFetching, refetch} = useWorkflowSearch({
    page, 
    rowsPerPage, 
    sort, 
    query: queryFT.query, 
        ...
        <Grid container spacing={3} className={classes.controls}>
          ...
          <Grid item xs={1}>
            <FormControl>
              ...
              <PrimaryButton onClick={doSearch}>
                Search
              </PrimaryButton>
            </FormControl>
          </Grid>
