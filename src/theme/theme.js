  ...
  overrides: {
    ...
    MuiOutlinedInput: {
      notchedOutline: {
        ...
        top: 0,
        "& legend": { // force-disable notched legends
          display: "none"
        }
      },
      root: {
      ...
      input: {
        padding: `${baseTheme.spacing("space2")}px ${baseTheme.spacing("space2")}px`,
      },
    },
    MuiFormControl: {
      root: {
    ...
    MuiDialogTitle: {
      root: {
        ...
        padding: `${baseTheme.spacing("space5")}px ${baseTheme.spacing("space4")}px`,
    ...
    MuiDialogActions: {
      root: {
        backgroundColor: baseTheme.palette.grey[50],
        padding: `${baseTheme.spacing("space3")}px ${baseTheme.spacing("space5")}px`,
