...
import { Paper, PrimaryButton, Heading, Dropdown, Input } from "../../components";

import { useTaskSearch, useTaskNames, useWorkflowNames } from "../../utils/query";
...
export default function TaskSearchPanel() {
  ...
  const results = useMemo(() => data ? [].concat.apply([], data.pages.map(page => page.results)): [], [data]);
