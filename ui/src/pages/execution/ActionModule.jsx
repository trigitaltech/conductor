...
export default function ActionModule({ execution, triggerReload }) {
  ...
  const restartAction = useAction(`/workflow/${workflowId}/restart`, "post", onSuccess);
  const retryAction = useAction(`/workflow/${workflowId}/retry?resumeSubworkflowTasks=false`, "post", onSuccess);
  const retryResumeSubworkflowTasksAction = useAction(`/workflow/${workflowId}/retry?resumeSubworkflowTasks=true`, "post", onSuccess);
  const terminateAction = useAction(`/workflow/${workflowId}`, "delete", onSuccess);
  const resumeAction = useAction(`/workflow/${workflowId}/resume`,"put", onSuccess);
  const pauseAction = useAction(`/workflow/${workflowId}/pause`, "put", onSuccess);
